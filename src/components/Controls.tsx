...
import type { Settings, DatasetKind, ActivationKind, ProblemType } from '../types'
...
export default function Controls(p: Props){
  ...
  const problems: ProblemType[] = ['classification','regression'];
    ...
    <aside className="sidebar">
      <div className="section">
        ...
        <div className="row">
          ...
          <select value={s.problemType} onChange={e=>p.set({problemType: e.target.value as ProblemType})}>
            {problems.map(pt=><option key={pt} value={pt}>{pt}</option>)}
          </select>
        </div>
        <div className="row">
          <label>Samples</label>
